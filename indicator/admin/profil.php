	...
	<?php include('includes/meniu.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Cont administrator</h3>
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Editeaza informatii</div>
...
<label class="col-sm-2 control-label">Utilizator<span style="color:red">*</span></label>
<div class="col-sm-4">
